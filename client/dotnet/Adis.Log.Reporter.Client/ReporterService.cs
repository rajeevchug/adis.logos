...
public interface IReporterContract
{
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReporterContract/GetCategoryList", ReplyAction="http://tempuri.org/IReporterContract/GetCategoryListResponse")]
    string[] GetCategoryList();
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReporterContract/GetApplicationList", ReplyAction="http://tempuri.org/IReporterContract/GetApplicationListResponse")]
    System.Collections.Generic.Dictionary<string, string[]> GetApplicationList();
}
...
public partial class ReporterContractClient : System.ServiceModel.ClientBase<IReporterContract>, IReporterContract
{
    ...
    public System.Collections.Generic.Dictionary<string, string[]> GetApplicationList()
    {
